...
public class NaijaMascotContract {
    ...
    private static class NaijaMascots implements NaijaMascotColumns, BaseColumns {
        public static final Uri URI_CONTENT =
                BASE_CONTENT_URI.buildUpon().appendEncodedPath(PATH_NAIJAMASCOT).build();

        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.com.naijamascot" + PATH_NAIJAMASCOT;
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.com.naijamascot" + PATH_NAIJAMASCOT;
